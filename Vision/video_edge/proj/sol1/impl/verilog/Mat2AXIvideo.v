...
reg   [7:0] t_V_1_reg_184;
wire   [0:0] exitcond1_fu_200_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [7:0] i_V_fu_206_p2;
reg   [7:0] i_V_reg_263;
...
assign axi_last_V_fu_224_p2 = ((t_V_1_reg_184 == 8'd219) ? 1'b1 : 1'b0);

assign exitcond1_fu_200_p2 = ((t_V_reg_173 == 8'd220) ? 1'b1 : 1'b0);

assign exitcond_fu_212_p2 = ((t_V_1_reg_184 == 8'd220) ? 1'b1 : 1'b0);

assign i_V_fu_206_p2 = (t_V_reg_173 + 8'd1);

assign j_V_fu_218_p2 = (t_V_1_reg_184 + 8'd1);

assign tmp_data_V_fu_234_p5 = {{{{{{8'd255}, {img_data_stream_2_V_dout}}}, {img_data_stream_1_V_dout}}}, {img_data_stream_0_V_dout}};
