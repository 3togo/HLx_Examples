...
struct Mat2AXIvideo : public sc_module {
    ...
    sc_signal< sc_lv<1> > exitcond_reg_268_pp0_iter1_reg;
    sc_signal< sc_lv<8> > t_V_1_reg_184;
    sc_signal< sc_lv<1> > exitcond1_fu_200_p2;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<8> > i_V_fu_206_p2;
    sc_signal< sc_lv<8> > i_V_reg_263;
    ...
    void thread_tmp_data_V_fu_234_p5();
