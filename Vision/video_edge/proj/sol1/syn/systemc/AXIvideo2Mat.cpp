...
const sc_lv<8> AXIvideo2Mat::ap_const_lv8_0 = "00000000";
const sc_lv<32> AXIvideo2Mat::ap_const_lv32_5 = "101";
const sc_lv<8> AXIvideo2Mat::ap_const_lv8_DC = "11011100";
const sc_lv<8> AXIvideo2Mat::ap_const_lv8_1 = "1";
...
AXIvideo2Mat::AXIvideo2Mat(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_ap_phi_mux_axi_data_V_1_phi_fu_210_p4);
    sensitive << ( ap_CS_fsm_pp1_stage0 );
    sensitive << ( ap_block_pp1_stage0 );
    sensitive << ( ap_enable_reg_pp1_iter1 );
    sensitive << ( exitcond_reg_410 );
    sensitive << ( axi_data_V_1_reg_207 );
    sensitive << ( p_Val2_s_reg_254 );

    SC_METHOD(thread_ap_phi_mux_eol_1_phi_fu_199_p4);
    sensitive << ( ap_CS_fsm_pp1_stage0 );
    sensitive << ( ap_block_pp1_stage0 );
    sensitive << ( ap_enable_reg_pp1_iter1 );
    sensitive << ( exitcond_reg_410 );
    sensitive << ( eol_1_reg_196 );
    sensitive << ( axi_last_V_2_reg_241 );

    SC_METHOD(thread_ap_phi_mux_eol_2_phi_fu_293_p4);
    sensitive << ( eol_2_reg_290 );
    ...
    sensitive << ( ap_enable_reg_pp1_iter1 );
    sensitive << ( exitcond_reg_410 );
    sensitive << ( eol_reg_229 );
    sensitive << ( axi_last_V_2_reg_241 );

    SC_METHOD(thread_ap_phi_mux_p_Val2_s_phi_fu_258_p4);
    sensitive << ( AXI_video_strm_V_data_V_0_data_out );
    sensitive << ( brmerge_fu_346_p2 );
    sensitive << ( ap_phi_mux_axi_data_V_1_phi_fu_210_p4 );
    sensitive << ( ap_phi_reg_pp1_iter0_p_Val2_s_reg_254 );
    sensitive << ( ap_condition_638 );

    SC_METHOD(thread_ap_phi_reg_pp1_iter0_axi_last_V_2_reg_241);

    SC_METHOD(thread_ap_phi_reg_pp1_iter0_p_Val2_s_reg_254);
    ...
    SC_METHOD(thread_brmerge_fu_346_p2);
    sensitive << ( ap_phi_mux_eol_phi_fu_233_p4 );
    sensitive << ( sof_1_fu_122 );

    SC_METHOD(thread_exitcond2_fu_319_p2);
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( t_V_reg_185 );

    SC_METHOD(thread_exitcond_fu_331_p2);
    sensitive << ( ap_CS_fsm_pp1_stage0 );
    sensitive << ( ap_enable_reg_pp1_iter0 );
    sensitive << ( t_V_3_reg_218 );
    sensitive << ( ap_block_pp1_stage0_11001 );
    ...
    SC_METHOD(thread_j_V_fu_337_p2);
    sensitive << ( t_V_3_reg_218 );
    ...
    SC_METHOD(thread_tmp_72_fu_352_p1);
    sensitive << ( ap_phi_mux_p_Val2_s_phi_fu_258_p4 );
    ...
    sensitive << ( exitcond_fu_331_p2 );
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( ap_phi_mux_eol_2_phi_fu_293_p4 );
    sensitive << ( exitcond2_fu_319_p2 );
    sensitive << ( ap_CS_fsm_state4 );
    ...
    sc_trace(mVcdFile, brmerge_fu_346_p2, "brmerge_fu_346_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state8, "ap_CS_fsm_state8");
    sc_trace(mVcdFile, ap_phi_mux_eol_2_phi_fu_293_p4, "ap_phi_mux_eol_2_phi_fu_293_p4");
    sc_trace(mVcdFile, img_data_stream_0_V_blk_n, "img_data_stream_0_V_blk_n");
    sc_trace(mVcdFile, ap_enable_reg_pp1_iter1, "ap_enable_reg_pp1_iter1");
    sc_trace(mVcdFile, exitcond_reg_410, "exitcond_reg_410");
    ...
    sc_trace(mVcdFile, eol_1_reg_196, "eol_1_reg_196");
    sc_trace(mVcdFile, axi_data_V_1_reg_207, "axi_data_V_1_reg_207");
    sc_trace(mVcdFile, t_V_3_reg_218, "t_V_3_reg_218");
    sc_trace(mVcdFile, eol_reg_229, "eol_reg_229");
    sc_trace(mVcdFile, axi_last_V_2_reg_241, "axi_last_V_2_reg_241");
    sc_trace(mVcdFile, p_Val2_s_reg_254, "p_Val2_s_reg_254");
    sc_trace(mVcdFile, tmp_data_V_reg_381, "tmp_data_V_reg_381");
    sc_trace(mVcdFile, tmp_last_V_reg_389, "tmp_last_V_reg_389");
    sc_trace(mVcdFile, exitcond2_fu_319_p2, "exitcond2_fu_319_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, i_V_fu_325_p2, "i_V_fu_325_p2");
    sc_trace(mVcdFile, i_V_reg_405, "i_V_reg_405");
    ...
    sc_trace(mVcdFile, j_V_fu_337_p2, "j_V_fu_337_p2");
    sc_trace(mVcdFile, tmp_72_fu_352_p1, "tmp_72_fu_352_p1");
    sc_trace(mVcdFile, tmp_72_reg_423, "tmp_72_reg_423");
    sc_trace(mVcdFile, tmp_17_reg_428, "tmp_17_reg_428");
    sc_trace(mVcdFile, tmp_18_reg_433, "tmp_18_reg_433");
    ...
    sc_trace(mVcdFile, axi_last_V_3_reg_266, "axi_last_V_3_reg_266");
    sc_trace(mVcdFile, axi_last_V1_reg_165, "axi_last_V1_reg_165");
    sc_trace(mVcdFile, ap_CS_fsm_state9, "ap_CS_fsm_state9");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, axi_data_V_3_reg_278, "axi_data_V_3_reg_278");
    sc_trace(mVcdFile, axi_data_V1_reg_175, "axi_data_V1_reg_175");
    sc_trace(mVcdFile, t_V_reg_185, "t_V_reg_185");
    sc_trace(mVcdFile, ap_phi_mux_eol_1_phi_fu_199_p4, "ap_phi_mux_eol_1_phi_fu_199_p4");
    sc_trace(mVcdFile, ap_phi_mux_axi_data_V_1_phi_fu_210_p4, "ap_phi_mux_axi_data_V_1_phi_fu_210_p4");
    sc_trace(mVcdFile, ap_phi_mux_eol_phi_fu_233_p4, "ap_phi_mux_eol_phi_fu_233_p4");
    sc_trace(mVcdFile, ap_phi_reg_pp1_iter0_axi_last_V_2_reg_241, "ap_phi_reg_pp1_iter0_axi_last_V_2_reg_241");
    sc_trace(mVcdFile, ap_phi_mux_p_Val2_s_phi_fu_258_p4, "ap_phi_mux_p_Val2_s_phi_fu_258_p4");
    sc_trace(mVcdFile, ap_phi_reg_pp1_iter0_p_Val2_s_reg_254, "ap_phi_reg_pp1_iter0_p_Val2_s_reg_254");
    sc_trace(mVcdFile, ap_CS_fsm_state7, "ap_CS_fsm_state7");
    sc_trace(mVcdFile, eol_2_reg_290, "eol_2_reg_290");
    sc_trace(mVcdFile, ap_block_pp1_stage0_01001, "ap_block_pp1_stage0_01001");
    sc_trace(mVcdFile, sof_1_fu_122, "sof_1_fu_122");
...
void AXIvideo2Mat::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(ap_const_lv1_1, exitcond2_fu_319_p2.read()))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        axi_data_V1_reg_175 = tmp_data_V_reg_381.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        axi_data_V1_reg_175 = axi_data_V_3_reg_278.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        axi_data_V_1_reg_207 = p_Val2_s_reg_254.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_319_p2.read()))) {
        axi_data_V_1_reg_207 = axi_data_V1_reg_175.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        axi_data_V_3_reg_278 = axi_data_V_1_reg_207.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && 
                !(esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_data_V_0_vld_out.read())))) {
        axi_data_V_3_reg_278 = AXI_video_strm_V_data_V_0_data_out.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        axi_last_V1_reg_165 = tmp_last_V_reg_389.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        axi_last_V1_reg_165 = axi_last_V_3_reg_266.read();
    }
    if (esl_seteq<1,1,1>(ap_condition_559.read(), ap_const_boolean_1)) {
        if ((esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()) && 
             esl_seteq<1,1,1>(ap_const_lv1_1, brmerge_fu_346_p2.read()))) {
            axi_last_V_2_reg_241 = ap_phi_mux_eol_1_phi_fu_199_p4.read();
        } else if ((esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()) && 
                    esl_seteq<1,1,1>(ap_const_lv1_0, brmerge_fu_346_p2.read()))) {
            axi_last_V_2_reg_241 = AXI_video_strm_V_last_V_0_data_out.read();
        } else if (esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1)) {
            axi_last_V_2_reg_241 = ap_phi_reg_pp1_iter0_axi_last_V_2_reg_241.read();
        }
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        axi_last_V_3_reg_266 = eol_1_reg_196.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && 
                !(esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_data_V_0_vld_out.read())))) {
        axi_last_V_3_reg_266 = AXI_video_strm_V_last_V_0_data_out.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        eol_1_reg_196 = axi_last_V_2_reg_241.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_319_p2.read()))) {
        eol_1_reg_196 = axi_last_V1_reg_165.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        eol_2_reg_290 = eol_reg_229.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && 
                !(esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_data_V_0_vld_out.read())))) {
        eol_2_reg_290 = AXI_video_strm_V_last_V_0_data_out.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        eol_reg_229 = axi_last_V_2_reg_241.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_319_p2.read()))) {
    ...
    if (esl_seteq<1,1,1>(ap_condition_559.read(), ap_const_boolean_1)) {
        if ((esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()) && 
             esl_seteq<1,1,1>(ap_const_lv1_1, brmerge_fu_346_p2.read()))) {
            p_Val2_s_reg_254 = ap_phi_mux_axi_data_V_1_phi_fu_210_p4.read();
        } else if ((esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()) && 
                    esl_seteq<1,1,1>(ap_const_lv1_0, brmerge_fu_346_p2.read()))) {
            p_Val2_s_reg_254 = AXI_video_strm_V_data_V_0_data_out.read();
        } else if (esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1)) {
            p_Val2_s_reg_254 = ap_phi_reg_pp1_iter0_p_Val2_s_reg_254.read();
        }
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        t_V_3_reg_218 = j_V_fu_337_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, exitcond2_fu_319_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        exitcond_reg_410 = exitcond_fu_331_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i_V_reg_405 = i_V_fu_325_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        tmp_17_reg_428 = ap_phi_mux_p_Val2_s_phi_fu_258_p4.read().range(15, 8);
        tmp_18_reg_433 = ap_phi_mux_p_Val2_s_phi_fu_258_p4.read().range(23, 16);
        tmp_72_reg_423 = tmp_72_fu_352_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(AXI_video_strm_V_data_V_0_vld_out.read(), ap_const_logic_1))) {
        tmp_data_V_reg_381 = AXI_video_strm_V_data_V_0_data_out.read();
        tmp_last_V_reg_389 = AXI_video_strm_V_last_V_0_data_out.read();
    }
}
...
void AXIvideo2Mat::thread_ap_block_state6_pp1_stage0_iter1() {
    ap_block_state6_pp1_stage0_iter1 = ((esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, img_data_stream_0_V_full_n.read())) || (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, img_data_stream_1_V_full_n.read())) || (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, img_data_stream_2_V_full_n.read())));
}

void AXIvideo2Mat::thread_ap_block_state8() {
    ap_block_state8 = (esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_data_V_0_vld_out.read()));
}
...
void AXIvideo2Mat::thread_ap_condition_638() {
    ap_condition_638 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()));
}

void AXIvideo2Mat::thread_ap_condition_pp1_exit_iter0_state5() {
    if (esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_fu_331_p2.read())) {
...
void AXIvideo2Mat::thread_ap_phi_mux_axi_data_V_1_phi_fu_210_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()))) {
        ap_phi_mux_axi_data_V_1_phi_fu_210_p4 = p_Val2_s_reg_254.read();
    } else {
        ap_phi_mux_axi_data_V_1_phi_fu_210_p4 = axi_data_V_1_reg_207.read();
    }
}

void AXIvideo2Mat::thread_ap_phi_mux_eol_1_phi_fu_199_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()))) {
        ap_phi_mux_eol_1_phi_fu_199_p4 = axi_last_V_2_reg_241.read();
    } else {
        ap_phi_mux_eol_1_phi_fu_199_p4 = eol_1_reg_196.read();
    }
}

void AXIvideo2Mat::thread_ap_phi_mux_eol_2_phi_fu_293_p4() {
    ap_phi_mux_eol_2_phi_fu_293_p4 = eol_2_reg_290.read();
}
...
void AXIvideo2Mat::thread_ap_phi_mux_eol_phi_fu_233_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_410.read()))) {
        ap_phi_mux_eol_phi_fu_233_p4 = axi_last_V_2_reg_241.read();
    } else {
        ap_phi_mux_eol_phi_fu_233_p4 = eol_reg_229.read();
    }
}

void AXIvideo2Mat::thread_ap_phi_mux_p_Val2_s_phi_fu_258_p4() {
    if (esl_seteq<1,1,1>(ap_condition_638.read(), ap_const_boolean_1)) {
        if (esl_seteq<1,1,1>(ap_const_lv1_1, brmerge_fu_346_p2.read())) {
            ap_phi_mux_p_Val2_s_phi_fu_258_p4 = ap_phi_mux_axi_data_V_1_phi_fu_210_p4.read();
        } else if (esl_seteq<1,1,1>(ap_const_lv1_0, brmerge_fu_346_p2.read())) {
            ap_phi_mux_p_Val2_s_phi_fu_258_p4 = AXI_video_strm_V_data_V_0_data_out.read();
        } else {
            ap_phi_mux_p_Val2_s_phi_fu_258_p4 = ap_phi_reg_pp1_iter0_p_Val2_s_reg_254.read();
        }
    } else {
        ap_phi_mux_p_Val2_s_phi_fu_258_p4 = ap_phi_reg_pp1_iter0_p_Val2_s_reg_254.read();
    }
...
void AXIvideo2Mat::thread_ap_phi_reg_pp1_iter0_axi_last_V_2_reg_241() {
    ap_phi_reg_pp1_iter0_axi_last_V_2_reg_241 =  (sc_lv<1>) ("X");
}

void AXIvideo2Mat::thread_ap_phi_reg_pp1_iter0_p_Val2_s_reg_254() {
    ap_phi_reg_pp1_iter0_p_Val2_s_reg_254 =  (sc_lv<32>) ("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
}

void AXIvideo2Mat::thread_ap_predicate_op50_read_state5() {
    ap_predicate_op50_read_state5 = (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_331_p2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, brmerge_fu_346_p2.read()));
}
...
void AXIvideo2Mat::thread_brmerge_fu_346_p2() {
    brmerge_fu_346_p2 = (sof_1_fu_122.read() | ap_phi_mux_eol_phi_fu_233_p4.read());
}

void AXIvideo2Mat::thread_exitcond2_fu_319_p2() {
    exitcond2_fu_319_p2 = (!t_V_reg_185.read().is_01() || !ap_const_lv8_DC.is_01())? sc_lv<1>(): sc_lv<1>(t_V_reg_185.read() == ap_const_lv8_DC);
}

void AXIvideo2Mat::thread_exitcond_fu_331_p2() {
    exitcond_fu_331_p2 = (!t_V_3_reg_218.read().is_01() || !ap_const_lv8_DC.is_01())? sc_lv<1>(): sc_lv<1>(t_V_3_reg_218.read() == ap_const_lv8_DC);
}

void AXIvideo2Mat::thread_i_V_fu_325_p2() {
    i_V_fu_325_p2 = (!t_V_reg_185.read().is_01() || !ap_const_lv8_1.is_01())? sc_lv<8>(): (sc_biguint<8>(t_V_reg_185.read()) + sc_biguint<8>(ap_const_lv8_1));
}
...
void AXIvideo2Mat::thread_img_data_stream_0_V_din() {
    img_data_stream_0_V_din = tmp_72_reg_423.read();
}
...
void AXIvideo2Mat::thread_img_data_stream_1_V_din() {
    img_data_stream_1_V_din = tmp_17_reg_428.read();
}
...
void AXIvideo2Mat::thread_img_data_stream_2_V_din() {
    img_data_stream_2_V_din = tmp_18_reg_433.read();
}
...
void AXIvideo2Mat::thread_j_V_fu_337_p2() {
    j_V_fu_337_p2 = (!t_V_3_reg_218.read().is_01() || !ap_const_lv8_1.is_01())? sc_lv<8>(): (sc_biguint<8>(t_V_3_reg_218.read()) + sc_biguint<8>(ap_const_lv8_1));
}
...
void AXIvideo2Mat::thread_tmp_72_fu_352_p1() {
    tmp_72_fu_352_p1 = ap_phi_mux_p_Val2_s_phi_fu_258_p4.read().range(8-1, 0);
}
...
void AXIvideo2Mat::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 4 : 
            ...
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond2_fu_319_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
            ...
            break;
        case 16 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_fu_331_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_fu_331_p2.read()))) {
        ...
        case 32 : 
            ...
            break;
        case 64 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_data_V_0_vld_out.read())))) {
                ap_NS_fsm = ap_ST_fsm_state8;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, eol_2_reg_290.read()) && esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_data_V_0_vld_out.read())) && esl_seteq<1,1,1>(ap_const_lv1_1, ap_phi_mux_eol_2_phi_fu_293_p4.read()))) {
