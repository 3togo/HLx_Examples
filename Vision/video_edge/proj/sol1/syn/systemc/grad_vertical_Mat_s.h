...
#ifndef _grad_vertical_Mat_s_HH_
#define _grad_vertical_Mat_s_HH_
...
struct grad_vertical_Mat_s : public sc_module {
    ...
    // Module declarations
    grad_vertical_Mat_s(sc_module_name name);
    SC_HAS_PROCESS(grad_vertical_Mat_s);
    ...
    sc_signal< sc_logic > grp_Filter2D_fu_122_ap_start;
    sc_signal< sc_logic > grp_Filter2D_fu_122_ap_done;
    sc_signal< sc_logic > grp_Filter2D_fu_122_ap_idle;
    sc_signal< sc_logic > grp_Filter2D_fu_122_ap_ready;
    sc_signal< sc_logic > grp_Filter2D_fu_122_p_src_data_stream_0_V_read;
    sc_signal< sc_logic > grp_Filter2D_fu_122_p_src_data_stream_1_V_read;
    sc_signal< sc_logic > grp_Filter2D_fu_122_p_src_data_stream_2_V_read;
    sc_signal< sc_lv<8> > grp_Filter2D_fu_122_p_dst_data_stream_0_V_din;
    sc_signal< sc_logic > grp_Filter2D_fu_122_p_dst_data_stream_0_V_write;
    sc_signal< sc_lv<8> > grp_Filter2D_fu_122_p_dst_data_stream_1_V_din;
    sc_signal< sc_logic > grp_Filter2D_fu_122_p_dst_data_stream_1_V_write;
    sc_signal< sc_lv<8> > grp_Filter2D_fu_122_p_dst_data_stream_2_V_din;
    sc_signal< sc_logic > grp_Filter2D_fu_122_p_dst_data_stream_2_V_write;
    sc_signal< sc_logic > grp_Filter2D_fu_122_ap_start_reg;
    ...
    void thread_grp_Filter2D_fu_122_ap_start();
