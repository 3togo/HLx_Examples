...
wire   [15:0] indvar_flatten_next_fu_254_p2;
reg    ap_block_state2;
reg   [15:0] indvar_flatten2_reg_240;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (img_out1_data_stream_2_V_full_n == 1'b0) | (img_out1_data_stream_1_V_full_n == 1'b0) | (img_out1_data_stream_0_V_full_n == 1'b0) | (img_out0_data_stream_2_V_full_n == 1'b0) | (img_out0_data_stream_1_V_full_n == 1'b0) | (img_out0_data_stream_0_V_full_n == 1'b0) | (img_in_data_stream_2_V_empty_n == 1'b0) | (img_in_data_stream_1_V_empty_n == 1'b0) | (img_in_data_stream_0_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state2) & (exitcond_flatten_fu_260_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (img_out1_data_stream_2_V_full_n == 1'b0) | (img_out1_data_stream_1_V_full_n == 1'b0) | (img_out1_data_stream_0_V_full_n == 1'b0) | (img_out0_data_stream_2_V_full_n == 1'b0) | (img_out0_data_stream_1_V_full_n == 1'b0) | (img_out0_data_stream_0_V_full_n == 1'b0) | (img_in_data_stream_2_V_empty_n == 1'b0) | (img_in_data_stream_1_V_empty_n == 1'b0) | (img_in_data_stream_0_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state2) & (exitcond_flatten_fu_260_p2 == 1'd0))) begin
        indvar_flatten2_reg_240 <= indvar_flatten_next_fu_254_p2;
    end else if (((~((real_start == 1'b0) | (img_out1_data_stream_2_V_full_n == 1'b0) | (img_out1_data_stream_1_V_full_n == 1'b0) | (img_out1_data_stream_0_V_full_n == 1'b0) | (img_out0_data_stream_2_V_full_n == 1'b0) | (img_out0_data_stream_1_V_full_n == 1'b0) | (img_out0_data_stream_0_V_full_n == 1'b0) | (img_in_data_stream_2_V_empty_n == 1'b0) | (img_in_data_stream_1_V_empty_n == 1'b0) | (img_in_data_stream_0_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state2) & (exitcond_flatten_fu_260_p2 == 1'd1)) | (~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        indvar_flatten2_reg_240 <= 16'd0;
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (img_out1_data_stream_2_V_full_n == 1'b0) | (img_out1_data_stream_1_V_full_n == 1'b0) | (img_out1_data_stream_0_V_full_n == 1'b0) | (img_out0_data_stream_2_V_full_n == 1'b0) | (img_out0_data_stream_1_V_full_n == 1'b0) | (img_out0_data_stream_0_V_full_n == 1'b0) | (img_in_data_stream_2_V_empty_n == 1'b0) | (img_in_data_stream_1_V_empty_n == 1'b0) | (img_in_data_stream_0_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = ((real_start == 1'b0) | (img_out1_data_stream_2_V_full_n == 1'b0) | (img_out1_data_stream_1_V_full_n == 1'b0) | (img_out1_data_stream_0_V_full_n == 1'b0) | (img_out0_data_stream_2_V_full_n == 1'b0) | (img_out0_data_stream_1_V_full_n == 1'b0) | (img_out0_data_stream_0_V_full_n == 1'b0) | (img_in_data_stream_2_V_empty_n == 1'b0) | (img_in_data_stream_1_V_empty_n == 1'b0) | (img_in_data_stream_0_V_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ready = internal_ap_ready;

assign exitcond_flatten_fu_260_p2 = ((indvar_flatten2_reg_240 == 16'd48399) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next_fu_254_p2 = (indvar_flatten2_reg_240 + 16'd1);

assign start_out = real_start;

endmodule //replicate_by2
